...
export default function FAQPage() {
  ...
  const sectionVariants = {
    ...
    visible: {
      opacity: 1,
      y: 0,
      // Fix: use a spring-only transition (no tween props) and keep type as a literal
    ...
    <main>
      ...
      <section className="relative w-full min-h-screen bg-blog-hero-final flex flex-col justify-center items-center text-center px-4 pt-[72px] md:pt-0">
        ...
        >
          ...
          <p className="font-inter text-lg md:text-xl text-stark-white/90 max-w-3xl mx-auto leading-relaxed mb-8">
      ...
      <section className="w-full bg-atmospheric-gray py-16 md:py-28 px-4 overflow-hidden">
        ...
        >
          {filteredFaqs.length === 0 && searchTerm !== "" ? (
            <p className="font-inter text-stark-white/80 text-center text-lg">
            ...
            <div className="space-y-4">
              {filteredFaqs.map((faq, index) => (
                <motion.div
                  ...
                  className="bg-imperial-void rounded-xl shadow-xl border border-atmospheric-gray"
                >
                  <button
