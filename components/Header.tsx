...
return (
<header
className={`fixed top-0 left-0 w-full z-50 transition-all ${         scrolled ? 'bg-imperial-void/90 backdrop-blur-md shadow-md' : 'bg-transparent'       }`}
>
...
/>
  ...
  {menuOpen && (
    <div className="md:hidden px-4 pb-4 text-stark-white space-y-4 bg-imperial-void transition-all duration-300">
      <Link href="/" className="block py-2 cursor-pointer transform transition-transform duration-200 hover:scale-105 hover:text-cyber-flare">Inicio</Link>
      <Link href="/servicios" className="block py-2 cursor-pointer transform transition-transform duration-200 hover:scale-105 hover:text-cyber-flare">Servicios</Link>
      <Link href="/precios" className="block py-2 cursor-pointer transform transition-transform duration-200 hover:scale-105 hover:text-cyber-flare">Precios</Link>
      <Link href="/casos-de-exito" className="block py-2 cursor-pointer transform transition-transform duration-200 hover:scale-105 hover:text-cyber-flare">Portafolio</Link>
      <Link href="/blog" className="block py-2 cursor-pointer transform transition-transform duration-200 hover:scale-105 hover:text-cyber-flare">Blog</Link>
      <Link href="/contacto" className="block py-2 cursor-pointer transform transition-transform duration-200 hover:scale-105 hover:text-cyber-flare">Contacto</Link>
    </div>
  )}
</header>
);
